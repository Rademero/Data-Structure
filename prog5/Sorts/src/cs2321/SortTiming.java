...
public class SortTiming {
	...
	public static void main(String [] args){
		...
		System.out.println("InPlaceInsertion: " + avgtime/1000000);
		
		testee= data.clone();
		avgtime = testSort(testee, new HeapPQSort<Integer>());	
		System.out.println("HeapPQSort: " + avgtime/1000000);
		
		testee= data.clone();
		avgtime = testSort(testee, new InPlaceHeapSort<Integer>());	
		System.out.println("InPlaceHeapSort: " + avgtime/1000000);
		
		testee= data.clone();
		avgtime = testSort(testee, new InPlaceSelectionSort<Integer>());	
		System.out.println("InPlaceSelectionSort: " + avgtime/1000000);
		
		testee= data.clone();
		avgtime = testSort(testee, new MergeSort<Integer>());	
		System.out.println("MergeSort: " + avgtime/1000000);
		
		testee= data.clone();
		avgtime = testSort(testee, new OrderedPQSort<Integer>());	
		System.out.println("OrderedPQSort: " + avgtime/1000000);
		
		testee= data.clone();
		avgtime = testSort(testee, new QuickSort<Integer>());	
		System.out.println("QuickSort: " + avgtime/1000000);
		
		testee= data.clone();
		avgtime = testSort(testee, new UnorderedPQSort<Integer>());	
		System.out.println("UnorderedPQSort: " + avgtime/1000000);
